...
/*fs.mkdir('node_modules/m2m/lib/sec', function (e){ //{recursive:true},
	if(e){
    return console.log('test mkdir e', e);
  }
  fs.writeFileSync('node_modules/m2m/lib/sec/ptk', 'node_modules/m2m/lib/sec/tk');
  let ctk = fs.readFileSync('test/sec/client/tk', 'utf8');
  fs.writeFileSync('node_modules/m2m/lib/sec/tk', ctk);
...
describe('\nCreating a client object ...', function () {
  ...
  describe('Test a local device object property - gpio()', function () {
    ...
    it('should execute output .gpio().on() callback if a valid data with error is returned', function (done) {
      ...
      m2mUtil.testEmitter.emit(eventName, { id:device.id, pin:pin, _pid:_pid, output:true, error:'fail' });
    });
    it('should execute output .gpio().on() callback if gpio output state is true or ON', function (done) {
      ...
      m2mUtil.testEmitter.emit(eventName, { id:device.id, pin:pin, _pid:_pid,  output:true, state:true });
    });
    it('should execute output .gpio().off() callback if gpio output state is false or OFF', function (done) {
      ...
      m2mUtil.testEmitter.emit(eventName, { id:device.id, pin:pin, _pid:_pid,  output:true, state:false });
    });
    ...
    it('process input.gpio().state() if argument is valid', function (done) {
      ...
      m2mUtil.testEmitter.emit(eventName, { id:device.id, pin:pin, _pid:_pid, input:'state', state:true });
    ...
    it('should execute input .gpio().state() callback if a valid data with error is returned', function (done) {
      ...
      m2mUtil.testEmitter.emit(eventName, { id:device.id, pin:pin, _pid:_pid, input:true, error:'fail' });
    });
    it('execute input .gpio().state() callback for valid data', function (done) {
      ...
      m2mUtil.testEmitter.emit(eventName, { id:device.id, pin:pin, _pid:_pid, input:true, state:true });
    });
    it('execute input gpio().getState() callback and return an error argument for invalid data', function (done) {
      ...
      m2mUtil.testEmitter.emit(eventName, { id:device.id, pin:pin,  _pid:_pid, input:true, error:'test-fail' });
    });
    ...
    it('execute input gpio().watch() callback for valid returned data', function (done) {
      ...
      m2mUtil.testEmitter.emit(eventName, { id:device.id, pin:pin,  _pid:_pid, input:true, state:false });
    });
    ...
    it('execute input gpio().unwatch() callback and return the result argument as true for valid watch pin', function (done) {
      ...
      m2mUtil.testEmitter.emit(eventName, { id:device.id, pin:pin, unwatch:true, _pid:_pid, input:true, state:true });
    });
    it('execute input gpio().unwatch() callback and return the error argument as "invalid pin" for invalid watch pin', function (done) {
      ...
      m2mUtil.testEmitter.emit(eventName, { id:device.id, pin:pin, unwatch:true, _pid:_pid, error:'invalid input', input:true, state:false });
    });
  });
  describe('Test a local device object property - device.in()', function () {
    ...
    it('execute in().unwatch() callback and return the result argument as true if watch pin is valid', function (done) {
      ...
      m2mUtil.testEmitter.emit(eventName, { id:device.id, pin:pin, unwatch:true, _pid:_pid, input:true, state:false });
    });
  ...
  describe('create a device object w/ setupInfo() w/o an error', function () {
    it('should return w/o an error object', function (done) {
      ...
      let spl = {id:'12ab8c92', appId:'12ab8c92', _pid:'r-a', m2mUtil:true, app:true, src:'client', reg:true};
      ...
      client.connect(function(err, result){
        ...
        device.setupInfo(function(err, data){
      	...
      	try{
		    	m2mUtil.testEmitter.emit(device.id + 'setupData', {id:device.id, _pid:'setupData', setupData:true});
				}
				catch(e){
					throw 'invalid test';
		    }
    ...
    it('should return w/ an error object', function (done) {
      ...
      client.connect(function(err, result){
        ...
        device.setupInfo(function(err, data){
      	...
      	try{
		    	m2mUtil.testEmitter.emit(device.id + 'setupData', {id:device.id, error:'invalid devices', _pid:'setupData', setupData:true, devices:[100, 200]});
				}
				catch(e){
					throw 'invalid test';
		    }
  ...
  describe('create a client object invoking .getDevices() method', function () {
    it('should return the available devices', function (done) {
      ...
      client.connect(function(err, result){
        ...
        m2mUtil.testEmitter.emit(eventName, {_pid:'getDevices', id:id, devices:[100, 200]});
    	});
   	});
 	});
  ...
  describe('create a client object invoking internal .setGetDeviceIdListener() method w/ valid data', function () {
    it('should accept the data internally if data is an integer or array', function () {
      ...
      c1.connect(function(err, result){
        ...
        m2mUtil.testEmitter.emit(eventName, [100, 200]);
        m2mUtil.testEmitter.emit(eventName, 200);
    	});
   	});
 	});
